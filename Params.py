...
def ParseArgs():
	...
	parser.add_argument("--guide_fused_hidden_dim", type=int, default=64, help="hidden dimensions guiding the fusion process under conditions")
	# parser.add_argument("--n_user", type=int, default=0, help="n_user")
	# parser.add_argument("--n_item", type=int, default=0, help="n_item")
